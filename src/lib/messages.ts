...
const MESSAGES: Record<Language, Record<string, string>> = {
  en: {
    ...
    'drawing.title': 'Draw what you\'re looking for',
    'drawing.pen': 'Pen',
    'drawing.eraser': 'Eraser',
    'drawing.clear': 'Clear',
    'drawing.interpret': 'Interpret drawing',
    'drawing.interpreting': 'Interpreting…',
    'drawing.interpreted': 'Lucy understood:',
    'drawing.button': 'Draw for me',
    'drawing.buttonTooltip': 'Open drawing canvas to sketch what you\'re looking for',
  ...
  es: {
    ...
    'drawing.title': 'Dibuja lo que buscas',
    'drawing.pen': 'Lápiz',
    'drawing.eraser': 'Borrador',
    'drawing.clear': 'Limpiar',
    'drawing.interpret': 'Interpretar dibujo',
    'drawing.interpreting': 'Interpretando…',
    'drawing.interpreted': 'Lucy entendió:',
    'drawing.button': 'Dibújalo',
    'drawing.buttonTooltip': 'Abre el canvas para dibujar lo que buscas',
